    ...
    <div class="commander-overlay">
        ...
        <div class="commander-article">
            <div class="commander-article-details">
                <p class="commander-article-time">À collecter aujourd'hui entre 17:00 et 19:00</p>
            </div>
        </div>
        ...
        <div class="commander-content">
            ...
            <div class="commander-form">
                ...
                <form action="" method="post" class="commander-confirmation-form">
                    ...
                    <label for="pickup-time" class="commander-label">Sélectionnez un point de collecte (qui est prêt de votre restaurant sélectionné):</label>
                    ...
                    <select id="pickup-time" name="pickup-time" class="commander-select" required>
                        <option value="16:00-16:30">17:00 - 17:30</option>
                        <option value="16:30-17:00">17:30 - 18:00</option>
                        <option value="17:00-17:30">18:00 - 18:30</option>
                        <option value="17:30-18:00">18:30 - 19:00</option>
                    </select>
                    <p class="retenue-text">
            Dès que vous confirmerai votre commande, vous recevrez un e-mail contenant tous les détails de votre commande. Merci de votre confiance et à bientôt dans votre point de collecte !
            </p>
